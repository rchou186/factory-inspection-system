/**
 * ============================================================================
 * 工廠環境衛生點檢管理系統 - 點檢項目資料模組
 * Factory Environmental Hygiene Inspection System - Inspection Items Module
 * ============================================================================
 * 
 * @file        InspectionItems.gs
 * @version     v2.2.5
 * @date        2026-01-26
 * @author      System Developer
 * @description 定義所有點檢區域和項目的資料結構，包含 11 個區域、105 個點檢項目
 *              及 6 個溫濕度記錄點
 * 
 * @structure
 *   總區域數：11 個
 *   總項目數：105 個點檢項目 + 6 個溫濕度記錄點
 * 
 * @areas
 *   1. 2F倉儲區 (3項)
 *   2. 研發實驗室 (2項)
 ...
 * 
 * @functions
 *   - getAllInspectionItems()         取得所有點檢項目
 * 
 * @dependencies
 *   無
 * 
